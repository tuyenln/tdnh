...
?>
	<div class="container">
		<div class="row">
			<div id="primary" class="content-area <?php echo $account_page ? 'col-md-12' : 'col-md-12'; // 'col-md-12 tyche-has-sidebar';?>">
				<main id="main" class="site-main" role="main">
					...
					while ( have_posts() ) :
						...
						if (is_page( array( 'about-us', 'contact' ))) {
							the_post_thumbnail('full', ['class' => 'img-responsive page_banner_image', 'title' => 'Feature image']);
						}
